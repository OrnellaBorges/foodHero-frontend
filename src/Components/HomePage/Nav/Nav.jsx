...
const Nav = (props) => {
  ...
  return (
    <nav className="navMenuDiv">
      <ul className={`menuList leftMenu flex ${isMenuOpen ? "" : "closedNav"}`}>
        <li className="closeNav navItem" onClick={() => setIsMenuOpen(false)}>
      ...
      <ul className="menuList centerMenu flex">
        ...
        <li className="navIcon navItem" onClick={() => setIsMenuOpen(true)}>
      ...
      {isLogged ? (
        <ul
          className={`menuList rightMenu flex ${isMenuOpen ? "" : "closedNav"}`}
        >
          <li className="navItem">
